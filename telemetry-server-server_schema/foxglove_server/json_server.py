...
with open('C:/Users/chris/PythonFun/WebApp_Files/venv/Scripts/telemetry-server-server_schema/foxglove_server/jsonschema/LocationFix.json', 'r') as file:
    LocationFix_schema = file.read()
with open('C:/Users/chris/PythonFun/WebApp_Files/venv/Scripts/telemetry-server-server_schema/foxglove_server/jsonschema/CompressedImage.json', 'r') as file:
    CompressedImage_schema = file.read()
with open('C:/Users/chris/PythonFun/WebApp_Files/venv/Scripts/telemetry-server-server_schema/foxglove_server/jsonschema/Log.json', 'r') as file:
